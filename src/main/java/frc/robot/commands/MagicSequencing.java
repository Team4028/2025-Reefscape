...
public class MagicSequencing {
        ...
        private static double DRIVE_TOL = 0.1;
                ...
                return Commands.runOnce(() -> isMagicScoreRunning = true)
                                ...
                                .andThen(Commands.runOnce(() -> armistice.setSafety(false))
                                                ...
                                                .alongWith(Commands.runOnce(() -> SmartDashboard.putString("MagicScore",
                                                                "ScoringAt " + scorePos.get().toPipe())))
                                                .andThen(armistice.waitUntilThingsInTolerance(1,
                                                                Units.degreesToRadians(2)))
                                                .andThen(armistice.runToPositionNoWait(
                                                                scorePos.get().toPipe().getSCPose()))
                                                .andThen(armistice.waitUntilThingsInTolerance(1,
                                                                Units.degreesToRadians(2))))
        ...
        public static Command magicAlgae(Drive drive,
                ...
                return Commands.runOnce(() -> isMagicScoreRunning = true)
                                ...
                                .andThen(Commands.runOnce(() -> armistice.setSafety(false))
                                                ...
                                                .andThen(armistice.waitUntilThingsInTolerance(2,
                                                                Units.degreesToRadians(2))))
                                .andThen(algae.runMotorCommandAlgae(0.95)
                                                .alongWith(drive
                                                                .translateToPositionWithPID(
                                                                                reefPosition.get()
                                                                                                .transformBy(new Transform2d(
                                                                                                                ...
                                                                                                                Rotation2d.kZero)))
                                                                .raceWith(drive.waitForDrivetrainDistance(.5))
                                                                .andThen(
                                                ...
                                                .andThen(drive.runVelocityAngle(() -> 0, () -> -1, drive::getRotation)
                                                                .withTimeout(0.5)
                                                                .alongWith(armistice.runToPositionNoWait(
