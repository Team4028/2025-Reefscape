...
public class DriveCommands {
    ...
    public static Command runVelocityAngle(Drive drive, DoubleSupplier xSupplier, DoubleSupplier ySupplier,
        ...
        return Commands.run(() -> {
            double omega = angleController.calculate(drive.getRotation().getRadians(), angle.get().getRadians());
            ChassisSpeeds speeds = new ChassisSpeeds(
