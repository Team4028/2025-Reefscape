...
public class RobotContainer {
        ...
        private final WhipStick algae = new WhipStickIOTalonFX().simSwitch();
        ...
        private final Trigger hasGamePiece = new Trigger(
                        infeed.hasGamepieceSupplier()
                                        .bsand(() -> armistice.getTargetPosition() == ArmisticePositions.CLEAN)
        ...
        private final Limelight ll4iii = new Limelight(
                        new LimelightIO("limelight-fouriii", true, Optional.empty(), true));
        private final Limelight ll4ii = new Limelight(
                        new LimelightIO("limelight-fourii", true, Optional.empty(), true));
        ...
        private static String whichSideSuperCycle(boolean isAltSuperCycle) {
                return isAltSuperCycle ? "left side" : "right side";
        }
        ...
        @AutoLogOutput
        private boolean isAltSuperCycle = false;
        @AutoLogOutput
        ...
        public RobotContainer() {
                                ...
                                Commands.runOnce(() -> armistice.setSafety(false))
                                                .andThen(armistice.runToPositionNoWait(ArmisticePositions.LOLI_ACQUIRE)
                                                                ...
                                                                .alongWith(infeed.runMotorCommand(.95)
                                                                                .alongWith(Commands.runOnce(() -> coral
                                                                                                .setHasGamepiece(
                                                                                                                false)))
                ...
                NamedCommands.registerCommand("Loli Stage",
                                armistice.runToPositionNoWait(ArmisticePositions.LOLI_ACQUIRE));
                ...
                NamedCommands.registerCommand("Acquire", ///
                                infeed.runMotorCommand(.95)
                                                ...
                                                .alongWith(pivot.runDown().asProxy()).andThen(
                                                                Commands.waitUntil(() -> armistice
                                                                                .getTargetPosition() == ArmisticePositions.CLEAN))
                                                .andThen(armistice
                                                ...
                                                .andThen(armistice.runToPositionNoWait(ArmisticePositions.STOW)
                                                                .alongWith(
                                                                                Commands.runOnce(() -> infeed
                                                                                                .setHasCoral(false))
                                                                                                .alongWith(infeed
                                                                                                                .directRunMotorCommand(
                                                                                                                                -0.2))))
                                                .finallyDo(() -> armistice
                                                                .waitUntilThingsInTolerance(1,
                ...
                NamedCommands.registerCommand("Acquire PreL2", ///
                                infeed.runMotorCommand(.95)
                                                ...
                                                .andThen(pivot.runUp().asProxy().onlyIf(pivot.isUp().bsnot()))
                                                .andThen(Commands.waitUntil(coral.hasGamePieceSupplier()))
                                                .andThen(armistice.runToPositionNoWait(ArmisticePositions.Cora_L2)
                                                                .alongWith(
                                                                                Commands.runOnce(() -> infeed
                                                                                                .setHasCoral(false))
                                                                                                .alongWith(infeed
                ...
                NamedCommands.registerCommand("Score Outfeed",
                                Commands.waitUntil(armistice.armAndElevatorAtTarget())
                                                .andThen(Commands
                                                                .defer(() -> coral.runMotorCommand(getOutfeedVBus()),
                                                                                Set.of(coral))
                ...
                NamedCommands.registerCommand("WaitUntilCloseAcq",
                                Commands.waitUntil(drive.driveCloseEnoughAcquireAuton()));
                                ...
                                Commands.runOnce(() -> {
                                        ...
                                        infeed.setHasCoral(false);
                                                ...
                                                .andThen(Commands.defer(this::runToClosestReefAuto,
                                                                Set.of(drive, armistice.getArm(),
                                                                                armistice.getElevator(), coral))));
                ...
                NamedCommands.registerCommand("Barge Score No Wait",
                                armistice.runToPositionNoWait(ArmisticePositions.BARGE));
                ...
                NamedCommands.registerCommand("Algae Grond Pos",
                                armistice.runToPositionCommand(ArmisticePositions.GROND));
                NamedCommands.registerCommand("Grond Acquire", coral.runMotorCommandAlgae(.95));
                NamedCommands.registerCommand("Close Barge",
                                armistice.runToPositionNoWait(ArmisticePositions.BARGE_CLOSE));
                ...
                if (!VisionUtil.requestingSeed
                                || VisionUtil.poseSources.keySet().stream()
                                                .allMatch(ll -> Math.abs(drive.getRotation()
                                                                .minus(Rotation2d
                                                                                .fromDegrees(ll.getLimelightRobotYaw()))
                                                                .getDegrees()) < 0.02)) {
        ...
        private void configureBindings() {
                ...
                Trigger leftStickPress = new Trigger(() -> operatorController.getHID().getLeftStickButton());

                Trigger leftTriggerRange = new Trigger(() -> {
                        double value = operatorController.getHID().getLeftTriggerAxis();
                ...
                operatorController.start()
                                .onTrue(Commands.runOnce(() -> isAltBarge = !isAltBarge).ignoringDisable(true));
                ...
                operatorController.rightBumper().onTrue(
                                Commands.runOnce(() -> drive.setReefTargetIsRight(true))
                                                .andThen(Commands.defer(this::runToClosestReef,
                                                                Set.of(drive, armistice.getArm(),
                                                                                armistice.getElevator(), coral)))
                                                .onlyIf(() -> !climbDeadmanUnsafe));

                // ==============================================
                // OC -- Back: SuperCycleAndMagicScore toggle
                // ==============================================
                leftTriggerRange.and(leftStickPress)
                                .onTrue(
                                                Commands.runOnce(() -> {
                                                        isAltSuperCycle = !isAltSuperCycle;
                                                        SmartDashboard.putString("SuperCycle",
                                                                        // alt super cycle = right reef
                                                                        "Scoring at: " + whichSideSuperCycle(
                                                                                        isAltSuperCycle));
                                                }));

                // ==============================================
                // OC -- custom trigger: SuperCycleAndMagicScore toggle
                // ==============================================
                operatorController.leftTrigger().and(leftStickPress)
                                .onTrue(Commands.runOnce(() -> {
                                        if (isAltSuperCycle) {
                                                Commands.runOnce(() -> drive.setReefTargetIsRight(true))
                                                                .andThen(Commands.defer(this::runToScoreAndSuperCycle,
                                                                                Set.of(drive, armistice.getArm(),
                                                                                                armistice.getElevator(),
                                                                                                coral, algae)));

                                        } else if (!isAltSuperCycle) {
                ...
                operatorController.rightTrigger()
                                .onTrue(Commands.defer(
                                                () -> coral.runMotorCommand(
                                                                coral.hasAlgae().getAsBoolean() ? -0.6 : /* L1 */ -0.1),
                                                Set.of(coral)))
                                .onFalse(coral.runMotorCommand(0));
                ...
                operatorController.axisGreaterThan(XboxController.Axis.kLeftY.value, 0.5)
                                .onTrue(armistice.runToPositionCommand(ArmisticePositions.GROND)
                                                .onlyIf(() -> !climbDeadmanUnsafe));
                operatorController.axisGreaterThan(XboxController.Axis.kLeftY.value, 0.5)
                ...
                operatorController.povRight()
                                .onTrue(armistice.runToPositionNoWait(ArmisticePositions.CLIMB)
                                                .alongWith(pivot.runUpClimb())
                ...
                operatorController.back()
                                .onTrue(Commands.runOnce(() -> climbDeadmanUnsafe = !climbDeadmanUnsafe)
                                                .ignoringDisable(true));
                ...
                operatorController.a()
                                .onTrue(Commands.runOnce(() -> armistice.setSafety(false))
                                                .andThen(armistice.runToPositionCommand(ArmisticePositions.GROND,
                                                                drive.closestReefName(),
                                                                drive.getReefTargetIsRight()))
                                                .andThen(coral.runMotorCommandAlgae(0.95)
                                                                .until(coral.hasAlgae()))
                                                .andThen(coral.stopMotorCommand())
                                                .alongWith(Commands.runOnce(() -> driverController
                ...
                if (Constants.CHAR_MODE) {
                        emergencyController.y().whileTrue(
                                        armistice.sysIDCommandElevator(() -> false, () -> Direction.kForward));
                        emergencyController.a().whileTrue(
                                        armistice.sysIDCommandElevator(() -> false, () -> Direction.kReverse));
                        emergencyController.povUp().whileTrue(
                                        armistice.sysIDCommandElevator(() -> true, () -> Direction.kForward));
                        ...
                        emergencyController.leftTrigger()
                                        .onTrue(pivot.runToPositionCommand(InfeedPivotPositions.HANDOFF.posRad));
                        emergencyController.axisMagnitudeGreaterThan(XboxController.Axis.kLeftX.value,
                                        ...
                                        .onTrue(Commands.runOnce(() -> drive.setReefTargetIsRight(
                                                        Math.signum(emergencyController.getRawAxis(
                                                                        XboxController.Axis.kLeftX.value)) > 0))
                                                        .ignoringDisable(true));
                } else {
                        // ==============================================
                        ...
                        emergencyController.axisMagnitudeGreaterThan(XboxController.Axis.kRightX.value,
                                        ...
                                        .onTrue(armistice.toggleCoralReefOffset()
                                                        .alongWith(setRumble(operatorController, 1,
                        ...
                        emergencyController.back()
                                        .onTrue(Commands.runOnce(() -> humanCam
                                                        .setCamera(climbDeadmanUnsafe = !climbDeadmanUnsafe))
                                                        .ignoringDisable(true));
                        ...
                        emergencyController.leftBumper().onTrue(Commands
                                        .runOnce(() -> drive.setReefTargetIsRight(false))
                                        .andThen(Commands.defer(this::runToClosestReefEmergency,
                                                        Set.of(drive, armistice.getArm(), armistice.getElevator(),
                                                                        coral)))
                                        .onlyIf(() -> !climbDeadmanUnsafe));
                        emergencyController.rightBumper().onTrue(Commands
                                        .runOnce(() -> drive.setReefTargetIsRight(true))
                                        .andThen(Commands.defer(this::runToClosestReefEmergency,
                                                        Set.of(drive, armistice.getArm(), armistice.getElevator(),
                                                                        coral)))
                                        .onlyIf(() -> !climbDeadmanUnsafe));
                ...
                return armistice.magicIsSnap() ? magicSnapL1()
                                : MagicSequencing.magicScore(drive, armistice, coral, drive::pipe1ClosestReefPose,
                                                ...
                                                .andThen(MagicSequencing
                                                                .magicAlgae(drive, armistice, coral,
                                                                                drive::pipe1AlgaeClosestReefPose,
        ...
        private Command runToScoreAndSuperCycle() {
                return MagicSequencing.superCycle(
                                drive, armistice, coral, algae,
                                () -> DriverStation.isAutonomous()
                                                ? ArmisticePositions.STOW
                                                : armistice.getFutureArmisticePositions(),
                                () -> drive.pipe1AlgaeClosestReefPose(),
                                () -> drive.pipe1ClosestReefPose(),
                                () -> DriverStation.isAutonomous()
        ...
        private Command runToClosestAlgae() {
                return Commands.defer(
                                () -> MagicSequencing.magicAlgae(drive, armistice, coral,
                                                drive::pipe1AlgaeClosestReefPose,
        ...
        private Command runToClosestAlgaeEmergency() {
                return Commands.defer(
                                () -> MagicSequencing.magicAlgae(drive, armistice, coral, drive::closestReefPoseAlgae,
                                                () -> armistice.getAutoAlgaePosition().getUnEmergencyPosition(),
                                                () -> isSuperCycle),
