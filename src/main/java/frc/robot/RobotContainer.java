...
public class RobotContainer {
        ...
        public RobotContainer() {
                ...
                NamedCommands.registerCommand("Acquire",
                                runAquire().andThen(coral.runMotorCommand(.7).alongWith(Commands.waitSeconds(1))
                ...
                NamedCommands.registerCommand("L3 Score",
                                runToL3().andThen(Commands.waitUntil(arm.atTargetPosition()))
                                                .andThen(coral.runMotorCommand(-.8)
                                                ...
                                                () -> drive.withVelocityX(
                                                                ...
                                                                .withVelocityY(yLimiter.calculate(
                                                                                ...
                                                                                * MaxSpeed) // Drive
                                                                                            ...
                                                                                            // (left)
                                                                .withRotationalRate(
                                                                                thetaLimiter.calculate(-driverController
                                                                                                .getRightX() * 0.4)
        ...
        public Command runToL4() {
                return elevator.runToPosition(50).alongWith(Commands.waitUntil(elevator.atTargetPosition()))
                                .andThen(arm.runToPositionCommand(Units.degreesToRadians(65.)));
        }

        public Command runToL3() {
                return elevator.runToPosition(56).alongWith(Commands.waitUntil(elevator.atTargetPosition()))
                                .andThen(arm.runToPositionCommand(Units.degreesToRadians(55)));
        }

        public Command runToL2() {
                return elevator.runToPosition(40.5).alongWith(Commands.waitUntil(elevator.atTargetPosition()))
                                .andThen(arm.runToPositionCommand(Units.degreesToRadians(55)));
        }

        public Command runAquire() {
                return elevator.runToPosition(16).alongWith(Commands.waitUntil(elevator.atTargetPosition()))
                                .andThen(arm.runToPositionCommand(Units.degreesToRadians(235)));
        }

        public Command runToStow() {
                return elevator.runToPosition(8).alongWith(Commands.waitUntil(elevator.atTargetPosition()))
