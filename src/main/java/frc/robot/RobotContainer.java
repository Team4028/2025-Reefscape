...
public class RobotContainer {
        ...
        private void configureBindings() {
                ...
                // ==============================================
                leftTriggerRange.and(operatorController.leftStick())
                                .onTrue(
                                                Commands.runOnce(() -> {
                ...
                // ==============================================
                operatorController.leftTrigger().and(operatorController.leftStick())
                ...
                operatorController.a()
                                .onTrue(Commands.runOnce(() -> armistice.setSafety(false))
                                                .andThen(armistice.runToPositionNoWait(ArmisticePositions.GROND,
                                                                drive.closestReefName(),
                                                                drive.getReefTargetIsRight()))
                                                .andThen(coral.runMotorCommandAlgae(0.95))
                                                .andThen(Commands.waitUntil(coral.hasAlgae()))
                                                .andThen(Commands.runOnce(() -> setRumble(driverController,
                                                                1.0,
