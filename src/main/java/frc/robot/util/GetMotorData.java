...
public class GetMotorData {
    ...
    public static final MotorData getTalonFXData(TalonFX talon) {
    ...
    public static final MotorData getSparkMaxData(SparkMax spark, AbsoluteEncoder sparkEncoder) {
    ...
    public static final MotorData getSparkMaxData(SparkMax spark) {
